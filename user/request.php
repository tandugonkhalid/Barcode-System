                        ...
                        <form method="post" action="request.php">
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm p-1 w-100 dropdown" name="appliances">
                        ...
                        <form method="post" action="restocking.php">
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <div class="p-2">
                                        <label class="form-check-label" for="">Moved Location</label>
                                    </div>
                                    <div class="p-1">
                                        <input type="date" class="form-control" name="moved_location" id="moved_locatinon">
                                    </div>
                                    <div class="p-2">
                                        <label class="form-check-label" for="">Date</label>
                                    </div>
                                    ...
                                    <div class="p-1">
                                        <input type="text" class="form-control" name="requested_by" id="requested" required>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
